...
const ShortsCardMobile: React.FC<ShortsCardMobileProps> = ({ short, language, index }) => {
  ...
  // YouTube 카테고리 ID를 실제 카테고리명으로 변환 (기존과 동일)
  ...
  // 채널 국가 정보를 실제 API 데이터로 변환 (기존과 동일)
...
export default ShortsCardMobile;